...
describe "cpanel/notifications/new" do
  before(:each) do
    assign(:cpanel_notification, stub_model(Cpanel::Notification,
      :body => "MyString",
      :read => false,
      :notif_type => 1
    ).as_new_record)
  ...
  it "renders new cpanel_notification form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => cpanel_notifications_path, :method => "post" do
